...
const ShoppingCart = () => {
  ...
  return (
    <>
      ...
      <aside className={`flex flex-col items-center gap-2 bg-black/90 text-white px-4 py-12 fixed right-0 top-0 w-52 z-40 ${open ? 'h-full opacity-100 translate-y-0' : 'h-0 opacity-0 -translate-y-56'} transition-all duration-300`}>
